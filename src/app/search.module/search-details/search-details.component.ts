...
export class SearchDetailsComponent implements OnInit {
  ...
  //start
  public listing: SkiSchoolModel = new SkiSchoolModel();
  ...
  public getListingByIdSki(id){
    this.searchResultsService.getListingByIdSki(id).subscribe((listingResponse) => {
      this.listing = listingResponse;
      console.info(this.listing , "=this.listing", listingResponse, "=this.listingResponse", "LISTING RESPONSE ID ")
    });
  }
